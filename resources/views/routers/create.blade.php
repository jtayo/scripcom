...
@section('title', 'New Router')
@section('page-title', 'New Router')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h2 class="h5 mb-0">Register Router</h2>
                            <div class="small text-muted">Add a new network router for monitoring</div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.routers.store') }}">
                        ...
                        <div class="row g-3">
                                ...
                                <div class="input-icon">
                                    ...
                                    <select id="hotspot_id" name="hotspot_id" class="form-select @error('hotspot_id') is-invalid @enderror" style="padding-left: 2.5rem;">
                                        ...
                                        @foreach($hotspots as $hotspot)
                                            <option value="{{ $hotspot->id }}" @selected(old('hotspot_id') == $hotspot->id)>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="model" name="model" class="form-control @error('model') is-invalid @enderror" value="{{ old('model') }}" placeholder="e.g. RB951Ui-2HnD">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="firmware_version" name="firmware_version" class="form-control @error('firmware_version') is-invalid @enderror" value="{{ old('firmware_version') }}" placeholder="e.g. 7.13.4">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="ip_address" name="ip_address" class="form-control @error('ip_address') is-invalid @enderror" value="{{ old('ip_address') }}" placeholder="e.g. 10.10.1.1">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="port" name="port" class="form-control @error('port') is-invalid @enderror" value="{{ old('port', 8728) }}" min="1" max="65535">
                        ...
                        <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary d-inline-flex align-items-center">
                                <i class="fa-solid fa-floppy-disk me-2"></i>Register Router
                            </button>
                        </div>
                    </form>
                </div>
