            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h2 class="h5 mb-0">Edit Campaign</h2>
                            <div class="small text-muted">Update {{ $campaign->title }} and its targeting rules</div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.campaigns.update', $campaign) }}">
                        ...
                        <div class="row g-3">
                                ...
                                <div class="input-icon">
                                    ...
                                    <select id="organization_id" name="organization_id" class="form-select @error('organization_id') is-invalid @enderror" style="padding-left: 2.5rem;">
                                        ...
                                        @foreach($organizations as $organization)
                                            <option value="{{ $organization->id }}" @selected(old('organization_id', $campaign->organization_id) == $organization->id)>{{ $organization->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="input-icon">
                                    ...
                                    <select id="sponsor_id" name="sponsor_id" class="form-select @error('sponsor_id') is-invalid @enderror" style="padding-left: 2.5rem;">
                                        ...
                                        @foreach($sponsors as $sponsor)
                                            <option value="{{ $sponsor->id }}" @selected(old('sponsor_id', $campaign->sponsor_id) == $sponsor->id)>{{ $sponsor->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="input-icon">
                                    ...
                                    <select id="type" name="type" class="form-select @error('type') is-invalid @enderror" style="padding-left: 2.5rem;" required>
                                        @foreach($types as $type)
                                            <option value="{{ $type->value }}" @selected(old('type', $campaign->type) === $type->value)>{{ $type->label() }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-icon">
                                    ...
                                    <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" rows="3" style="padding-left: 2.5rem;">{{ old('description', $campaign->description) }}</textarea>
                                ...
                                <div class="input-icon">
                                    ...
                                    <select id="content_type" name="content_type" class="form-select @error('content_type') is-invalid @enderror" style="padding-left: 2.5rem;" required>
                                        @foreach(['image', 'video', 'html'] as $contentType)
                                            <option value="{{ $contentType }}" @selected(old('content_type', $campaign->content_type) === $contentType)>{{ ucfirst($contentType) }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="url" id="content_url" name="content_url" class="form-control @error('content_url') is-invalid @enderror" value="{{ old('content_url', $campaign->content_url) }}" placeholder="https://...">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="video_caption" name="video_caption" class="form-control @error('video_caption') is-invalid @enderror" value="{{ old('video_caption', $campaign->video_caption) }}" placeholder="e.g. Powered by Safaricom">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="thumbnail" name="thumbnail" class="form-control @error('thumbnail') is-invalid @enderror" value="{{ old('thumbnail', $campaign->thumbnail) }}" placeholder="https://...">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="url" id="redirect_url" name="redirect_url" class="form-control @error('redirect_url') is-invalid @enderror" value="{{ old('redirect_url', $campaign->redirect_url) }}" placeholder="https://...">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="duration_seconds" name="duration_seconds" class="form-control @error('duration_seconds') is-invalid @enderror" value="{{ old('duration_seconds', $campaign->duration_seconds ?? 15) }}" min="1" max="600" required>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="priority" name="priority" class="form-control @error('priority') is-invalid @enderror" value="{{ old('priority', $campaign->priority ?? 0) }}">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="max_plays" name="max_plays" class="form-control @error('max_plays') is-invalid @enderror" value="{{ old('max_plays', $campaign->max_plays) }}" min="1" placeholder="Unlimited if empty">
                                ...
                                <div class="input-icon">
                                    ...
                                    <select id="status" name="status" class="form-select @error('status') is-invalid @enderror" style="padding-left: 2.5rem;" required>
                                        @foreach(['draft', 'active', 'paused', 'ended'] as $status)
                                            <option value="{{ $status }}" @selected(old('status', $campaign->status) === $status)>{{ ucfirst($status) }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="datetime-local" id="starts_at" name="starts_at" class="form-control @error('starts_at') is-invalid @enderror" value="{{ old('starts_at', $campaign->starts_at?->format('Y-m-d\TH:i')) }}">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="datetime-local" id="ends_at" name="ends_at" class="form-control @error('ends_at') is-invalid @enderror" value="{{ old('ends_at', $campaign->ends_at?->format('Y-m-d\TH:i')) }}">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="hotspot_ids[]" id="hotspot_ids" class="form-select @error('hotspot_ids') is-invalid @enderror" multiple size="6">
                                        @foreach($hotspots as $hotspot)
                                            <option value="{{ $hotspot->id }}" @selected(in_array($hotspot->id, old('hotspot_ids', $campaign->hotspots->pluck('id')->toArray())))>{{ $hotspot->name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row g-3 mt-1">
                            <div class="col-12 col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="skip_allowed" id="skip_allowed" value="1" @checked(old('skip_allowed', $campaign->skip_allowed))>
                                    <label class="form-check-label" for="skip_allowed">Skip Allowed</label>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_mandatory" id="is_mandatory" value="1" @checked(old('is_mandatory', $campaign->is_mandatory))>
                                    <label class="form-check-label" for="is_mandatory">Mandatory</label>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" @checked(old('is_active', $campaign->is_active))>
                        ...
                        <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary d-inline-flex align-items-center">
                                <i class="fa-solid fa-floppy-disk me-2"></i>Update Campaign
                            </button>
                        </div>
                    </form>
                </div>
