...
@section('title', 'New Wi-Fi Package')
@section('page-title', 'New Wi-Fi Package')
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="small text-muted">Define a Wi-Fi access package</div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="code" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="e.g. FREE-2H" required>
                                ...
                                <div class="input-icon">
                                    ...
                                    <select id="access_type" name="access_type" class="form-select @error('access_type') is-invalid @enderror" style="padding-left: 2.5rem;" required>
                                        @foreach(['free', 'paid', 'sponsored'] as $type)
                                            <option value="{{ $type }}" @selected(old('access_type', 'free') === $type)>{{ ucfirst($type) }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="duration_minutes" name="duration_minutes" class="form-control @error('duration_minutes') is-invalid @enderror" value="{{ old('duration_minutes', 120) }}" min="1" required>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="bandwidth_down_kbps" name="bandwidth_down_kbps" class="form-control @error('bandwidth_down_kbps') is-invalid @enderror" value="{{ old('bandwidth_down_kbps') }}" min="0" placeholder="e.g. 10240">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="bandwidth_up_kbps" name="bandwidth_up_kbps" class="form-control @error('bandwidth_up_kbps') is-invalid @enderror" value="{{ old('bandwidth_up_kbps') }}" min="0" placeholder="e.g. 5120">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="data_limit_mb" name="data_limit_mb" class="form-control @error('data_limit_mb') is-invalid @enderror" value="{{ old('data_limit_mb') }}" min="0" placeholder="Leave empty for unlimited">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="simultaneous_devices" name="simultaneous_devices" class="form-control @error('simultaneous_devices') is-invalid @enderror" value="{{ old('simultaneous_devices', 1) }}" min="1">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-selectgroup">
                                    <label class="form-selectgroup-item">
                                        <input type="radio" name="is_active" value="1" class="form-selectgroup-input" @checked(old('is_active', '1') === '1' || old('is_active', 1) == 1)>
                                        <span class="form-selectgroup-label"><i class="fa-solid fa-circle-check text-success me-1"></i>Active</span>
                                    </label>
                                    <label class="form-selectgroup-item">
                                        <input type="radio" name="is_active" value="0" class="form-selectgroup-input" @checked(old('is_active') === '0')>
