...
@section('title', 'New Hotspot')
@section('page-title', 'New Hotspot')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h2 class="h5 mb-0">Create Hotspot</h2>
                            <div class="small text-muted">Register a new wireless hotspot on the platform</div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.hotspots.store') }}">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="text-uppercase small fw-bold text-secondary mb-1">Hotspot Details</div>
                                <hr class="mt-1 mb-3">
                            </div>
                            ...
                            <div class="col-12 col-md-6 @if(!$organizations) offset-md-3 @endif">
                                ...
                                <div class="input-icon">
                                    <span class="input-icon-addon"><i class="fa-solid fa-network-wired"></i></span>
                                    <input type="number" id="router_id" name="router_id" class="form-control @error('router_id') is-invalid @enderror" value="{{ old('router_id') }}" placeholder="e.g. 1">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="ssid" name="ssid" class="form-control @error('ssid') is-invalid @enderror" value="{{ old('ssid') }}">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="device_model" name="device_model" class="form-control @error('device_model') is-invalid @enderror" value="{{ old('device_model') }}">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="firmware_version" name="firmware_version" class="form-control @error('firmware_version') is-invalid @enderror" value="{{ old('firmware_version') }}">
                                    @error('firmware_version') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="text-uppercase small fw-bold text-secondary mb-1">Location</div>
                                <hr class="mt-1 mb-3">
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="ip_address" name="ip_address" class="form-control @error('ip_address') is-invalid @enderror" value="{{ old('ip_address') }}" placeholder="192.168.1.1">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="mac_address" name="mac_address" class="form-control @error('mac_address') is-invalid @enderror" value="{{ old('mac_address') }}" placeholder="AA:BB:CC:DD:EE:FF">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="isp" name="isp" class="form-control @error('isp') is-invalid @enderror" value="{{ old('isp') }}">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="bandwidth_up" name="bandwidth_up" class="form-control @error('bandwidth_up') is-invalid @enderror" value="{{ old('bandwidth_up') }}" min="0">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="bandwidth_down" name="bandwidth_down" class="form-control @error('bandwidth_down') is-invalid @enderror" value="{{ old('bandwidth_down') }}" min="0">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    <span class="input-icon-addon"><i class="fa-solid fa-satellite"></i></span>
                                    <input type="text" id="latitude" name="latitude" class="form-control @error('latitude') is-invalid @enderror" value="{{ old('latitude') }}" step="any" placeholder="e.g. -4.0435">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    <span class="input-icon-addon"><i class="fa-solid fa-satellite"></i></span>
                                    <input type="text" id="longitude" name="longitude" class="form-control @error('longitude') is-invalid @enderror" value="{{ old('longitude') }}" step="any" placeholder="e.g. 39.6682">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="ward" name="ward" class="form-control @error('ward') is-invalid @enderror" value="{{ old('ward') }}">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    <span class="input-icon-addon"><i class="fa-solid fa-map-location-dot"></i></span>
                                    <input type="text" id="sub_county" name="sub_county" class="form-control @error('sub_county') is-invalid @enderror" value="{{ old('sub_county') }}">
                                    @error('sub_county') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="text-uppercase small fw-bold text-secondary mb-1">Network Settings</div>
                                <hr class="mt-1 mb-3">
                            </div>
                                ...
                                <div class="input-icon">
                                    ...
                                    <select id="status" name="status" class="form-select @error('status') is-invalid @enderror" style="padding-left: 2.5rem;" required>
                                        @foreach(['online', 'offline', 'degraded', 'maintenance'] as $status)
                                            <option value="{{ $status }}" @selected(old('status', 'online') === $status)>{{ ucfirst($status) }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="max_clients" name="max_clients" class="form-control @error('max_clients') is-invalid @enderror" value="{{ old('max_clients') }}" min="1">
                            ...
                            <div class="col-12">
                                ...
                                <select name="campaign_ids[]" id="campaign_ids" class="form-select @error('campaign_ids') is-invalid @enderror" multiple size="5">
                                    @foreach($campaigns as $campaign)
                                        <option value="{{ $campaign->id }}" @selected(in_array($campaign->id, old('campaign_ids', [])))>{{ $campaign->title }} ({{ $campaign->type }})</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                            <a href="{{ route('admin.hotspots.index') }}" class="btn btn-outline-secondary d-inline-flex align-items-center">
                                <i class="fa-solid fa-arrow-left me-2"></i>Cancel
                            </a>
                            <button type="submit" class="btn btn-primary d-inline-flex align-items-center">
                                <i class="fa-solid fa-wifi me-2"></i>Create Hotspot
                            </button>
                        </div>
                    </form>
                </div>
