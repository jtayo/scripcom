...
@section('content')
    <div class="mb-3">
        <a href="{{ route('admin.hotspots.index') }}" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center">
            <i class="fa-solid fa-arrow-left me-1"></i>Back to Hotspots
        </a>
    </div>
