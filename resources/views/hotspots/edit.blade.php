            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h2 class="h5 mb-0">Edit Hotspot</h2>
                            <div class="small text-muted">Update {{ $hotspot->name }} and its network settings</div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.hotspots.update', $hotspot) }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="latitude" name="latitude" class="form-control @error('latitude') is-invalid @enderror" value="{{ old('latitude', $hotspot->latitude) }}" step="any" placeholder="e.g. -4.0435">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    <span class="input-icon-addon"><i class="fa-solid fa-satellite"></i></span>
                                    <input type="text" id="longitude" name="longitude" class="form-control @error('longitude') is-invalid @enderror" value="{{ old('longitude', $hotspot->longitude) }}" step="any" placeholder="e.g. 39.6682">
                        ...
                        <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary d-inline-flex align-items-center">
                                <i class="fa-solid fa-floppy-disk me-2"></i>Update Hotspot
                            </button>
                        </div>
                    </form>
                </div>
