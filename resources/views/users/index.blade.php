                                ...
                                <tr>
                                    <td class="text-body fw-bold">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ $user->avatar ?? asset('img/team/profile-picture-3.jpg') }}" class="avatar rounded-circle me-2" alt="{{ $user->name }}">
                                            <div>
                                    ...
                                    <td>
                                        <span class="badge bg-{{ $user->status === 'active' ? 'success' : 'danger' }}">{{ ucfirst($user->status ?? 'active') }}</span>
                                    </td>
                                    <td class="text-end">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.users.show', $user) }}" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center">View</a>
                                            @can('update-user')
                                            <a href="{{ route('admin.users.edit', $user) }}" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center">Edit</a>
                                            @endcan
                                            @can('delete-user')
