...
<head>
    ...
    <link type="text/css" href="{{ asset('vendor/tabler/vendor/chartist/chartist.min.css') }}" rel="stylesheet">
...
<body>
            ...
            <div class="container-fluid">
                ...
                <h1 class="navbar-brand navbar-brand-autodark">
                    <a href="{{ route('admin.dashboard') }}">
                        <img src="{{ asset('scripcom_logo.png') }}" class="navbar-brand-image" alt="{{ config('app.name') }}">
                    </a>
                </h1>
                    ...
                    <ul class="navbar-nav pt-lg-3">
                        ...
                        <li class="nav-item {{ request()->routeIs('admin.campaigns.*') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.campaigns.index') }}">
                                <span class="nav-link-icon"><i class="ti ti-bullhorn"></i></span>
                                <span class="nav-link-title">Campaigns</span>
                            </a>
                        </li>
                        @endcan

                        @if(auth()->user()->can('view-any-sponsor') || auth()->user()->can('view-any-sponsorship') || auth()->user()->can('buy-credits'))
                        ...
                        @if(auth()->user()->can('view-any-session') || auth()->user()->can('view-any-event') || auth()->user()->can('view-any-payment'))
                        ...
                        <div class="col-auto ms-auto d-print-none">
                            <div class="dropdown">
                                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                                    <span class="avatar avatar-sm me-2" style="background-image: url('{{ auth()->user()->avatar ?? asset('img/team/profile-picture-3.jpg') }}')"></span>
                    ...
                    <div class="row text-center align-items-center flex-row-reverse">
                        <div class="col-lg-auto ms-lg-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item"><a href="{{ route('admin.settings') }}">Settings</a></li>
                                <li class="list-inline-item"><a href="{{ config('app.url') }}">Public Portal</a></li>
                            </ul>
                        </div>
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                            &copy; {{ date('Y') }} <a href="#" class="text-reset text-primary">{{ config('app.name') }}</a> — Powered by Tabler.
                        </div>
                    </div>
                </div>
            </footer>
    ...
    <script src="{{ asset('vendor/tabler/vendor/chartist/chartist.min.js') }}"></script>
    @stack('scripts')
</body>
