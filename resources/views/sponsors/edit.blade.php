                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="color" id="brand_color_picker" value="{{ old('brand_color', $sponsor->brand_color ?? '#262B40') }}" class="form-control form-control-color" style="max-width: 3rem; padding: .25rem;">
                                    <input type="text" id="brand_color" name="brand_color" class="form-control @error('brand_color') is-invalid @enderror" value="{{ old('brand_color', $sponsor->brand_color ?? '#262B40') }}" placeholder="#262B40">
