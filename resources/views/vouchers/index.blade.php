            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        ...
                        <div class="small text-muted">Issue and manage redemption vouchers for promotions</div>
                    </div>
                    <div class="card-actions d-flex align-items-center gap-2">
                        <form method="GET" action="{{ route('admin.vouchers.index') }}" class="d-flex gap-1">
                            ...
                            <select name="status" class="form-select" style="width: auto;" aria-label="Filter by status">
                                ...
                                @foreach(['unused', 'used', 'expired', 'revoked'] as $status)
                            ...
                            <tr>
                                <td colspan="9" class="text-center text-muted py-5">
                                    <div class="my-4">
                                        ...
                                        @else
                                        <div class="small text-secondary mt-1">
                                            <a href="{{ route('admin.vouchers.create') }}" class="text-primary">Generate a batch</a> of voucher codes for a promotion.
                                        </div>
                                        @endif
                                    </div>
                                </td>
