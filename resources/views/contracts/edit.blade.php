            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h2 class="h5 mb-0">Edit Contract</h2>
                            <div class="small text-muted">{{ $contract->contract_number }} &middot; {{ $contract->title }}</div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.contracts.update', $contract) }}">
                        ...
                        <div class="row g-3">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <select id="organization_id" name="organization_id" class="form-select @error('organization_id') is-invalid @enderror" style="padding-left: 2.5rem;">
                                            ...
                                            @foreach($organizations as $organization)
                                                <option value="{{ $organization->id }}" @selected(old('organization_id', $contract->organization_id) == $organization->id)>{{ $organization->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="input-icon">
                                    ...
                                    <select id="sponsor_id" name="sponsor_id" class="form-select @error('sponsor_id') is-invalid @enderror" style="padding-left: 2.5rem;">
                                        ...
                                        @foreach($sponsors as $sponsor)
                                            <option value="{{ $sponsor->id }}" @selected(old('sponsor_id', $contract->sponsor_id) == $sponsor->id)>{{ $sponsor->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="input-icon">
                                    ...
                                    <select id="type" name="type" class="form-select @error('type') is-invalid @enderror" style="padding-left: 2.5rem;" required>
                                        @foreach(['county', 'corporate', 'advertising'] as $type)
                                            <option value="{{ $type }}" @selected(old('type', $contract->type) === $type)>{{ ucfirst($type) }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="date" id="start_date" name="start_date" class="form-control @error('start_date') is-invalid @enderror" value="{{ old('start_date', $contract->start_date?->toDateString()) }}" required>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="date" id="end_date" name="end_date" class="form-control @error('end_date') is-invalid @enderror" value="{{ old('end_date', $contract->end_date?->toDateString()) }}" required>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="sessions_allocated" name="sessions_allocated" class="form-control @error('sessions_allocated') is-invalid @enderror" value="{{ old('sessions_allocated', $contract->sessions_allocated) }}" min="0" required>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="unit_price" name="unit_price" class="form-control @error('unit_price') is-invalid @enderror" value="{{ old('unit_price', $contract->unit_price) }}" min="0" step="0.01" required>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" id="tax_rate" name="tax_rate" class="form-control @error('tax_rate') is-invalid @enderror" value="{{ old('tax_rate', $contract->tax_rate ?? 16) }}" min="0" max="100" step="0.01">
                            ...
                            <div class="col-12">
                                ...
                                <textarea id="notes" name="notes" class="form-control @error('notes') is-invalid @enderror" rows="3">{{ old('notes', $contract->notes) }}</textarea>
                        ...
                        <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary d-inline-flex align-items-center">
                                <i class="fa-solid fa-floppy-disk me-2"></i>Update Contract
                            </button>
                        </div>
                    </form>
                </div>
