                    ...
                    <form method="POST" action="{{ route('admin.sponsorships.update', $sponsorship) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea id="notes" name="notes" class="form-control @error('notes') is-invalid @enderror" rows="3">{{ old('notes', $sponsorship->notes) }}</textarea>
                        ...
                        <div class="mb-4">
                            <div class="alert alert-info mb-0 small">
                                Current total: <strong>{{ $sponsorship->currency }} {{ number_format($sponsorship->total_amount, 2) }}</strong>. Total amount will be recomputed as <strong>quantity &times; unit price</strong>.
                            </div>
                        </div>

                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admin.sponsorships.index') }}" class="btn btn-outline-secondary">Cancel</a>
                            <button type="submit" class="btn btn-primary d-inline-flex align-items-center">Update Sponsorship</button>
                        </div>
                    </form>
                </div>
            </div>
